...
#[derive(Default)]
pub struct TransientHeatMassFlow {
...
impl TransientHeatMassFlow {
    pub fn new(num_comp: usize) -> TransientHeatMassFlow {
        // initialize struct
        let mut phys = TransientHeatMassFlow::default();
...
impl TransientBase for TransientHeatMassFlow {
