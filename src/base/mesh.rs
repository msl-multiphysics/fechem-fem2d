...
pub struct Mesh {
    ...
    pub elm2d_node: Vec<usize>,  // number of nodes (3 - tri; 4 - quad)
    ...
    pub elm1d_node: Vec<usize>,  // number of nodes (2 - lin)
