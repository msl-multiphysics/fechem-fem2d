...
pub struct Mesh {
    ...
    pub elm2d_type: Vec<usize>,         // type of element (13 - P1 tri; 14 - P1 quad)
    pub elm2d_node: Vec<usize>,         // number of nodes (3 - P1 tri; 4 - P1 quad)
    ...
    pub elm1d_type: Vec<usize>,         // type of element (2 - P1 lin)
    pub elm1d_node: Vec<usize>,         // number of nodes (2 - P1 lin)
    ...
    pub fn new_from_bounds(x_min: f64, y_min: f64, x_max: f64, y_max: f64, num_elm_x: usize, num_elm_y: usize) -> Result<Mesh, FEChemError> {
        ...
        for j in 0..num_elm_y {
            for i in 0..num_elm_x {
                ...
                dom.elm2d_type.push(14); // P1 quad
                dom.elm2d_node.push(4); // quad4
        ...
        for j in (0..num_elm_y).rev() {
            ...
            dom.elm1d_type.push(2); // P1 lin
            dom.elm1d_node.push(2); // lin2
